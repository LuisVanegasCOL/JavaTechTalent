...
let score = 0;
let answers: { question: string, correctAnswer: string, selectedAnswer: string }[] = []; // Array para almacenar preguntas con sus respuestas correctas y las seleccionadas
...
function checkAnswer(selected: string, correct: string, question: string) {
